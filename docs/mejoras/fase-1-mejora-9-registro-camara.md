# Fase 1 — Mejora #9: Flujo de Registro con Verificación de Cédula por Cámara

## Resumen

Esta mejora implementó el flujo completo de registro de usuario en 4 pasos, integrando captura de cámara (CameraX) para verificar la identidad del usuario mediante fotografía de su cédula por ambos lados. También se resolvió la incompatibilidad de dependencias entre CameraX y AGP 9.x, y se estandarizó el diseño visual en todos los pasos.
...
Antes de esta mejora existían solo 3 pasos (`FORMULARIO`, `CAMARA_FRONTAL`, `CAMARA_TRASERA`), sin pantalla de confirmación, y el botón "Registrarse" estaba dentro del formulario.
...
## Commits de esta mejora

| SHA | Descripción |
|---|---|
| [`1bd220f`](https://github.com/johnmesa-cell/HadesCoin/commit/1bd220f5f013fb1da4aa6d3f95d11e66d096b4b4) | Actualizar CameraX a 1.5.0-alpha06 y corregir tipos en mutableStateOf |
| [`c23daad`](https://github.com/johnmesa-cell/HadesCoin/commit/c23daade4566df5bd04866d70a86bda7491eb5a8) | Flujo de 4 pasos, paso 4 confirmación con crear cuenta, ícono material en botón cámara |
| [`35d3358`](https://github.com/johnmesa-cell/HadesCoin/commit/35d335854ee64c3e49bdc6d02d98b7a4a91d8fce) | Estandarizar totalSteps=4 en cámara y agregar botón volver a login en todos los pasos |
| [`6d74343`](https://github.com/johnmesa-cell/HadesCoin/commit/6d74343eeedfe86c8e679a266e760465de6835bf) | Corregir tipo `() -> Unit` en goToLogin y limpiar advertencias |
| [`2feb0f7`](https://github.com/johnmesa-cell/HadesCoin/commit/2feb0f7984ee6a47ee965c7d50c93250b2cf2bfd) | Estandarizar botón iniciar sesión al mismo estilo en todos los pasos |
| [`df6bcb1`](https://github.com/johnmesa-cell/HadesCoin/commit/df6bcb1586028df8c90408414d428103a1fc9776) | Documentación inicial (nombre incorrecto, reemplazado por este archivo) |
